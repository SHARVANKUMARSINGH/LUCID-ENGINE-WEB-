...
export class ForwardRenderer extends Renderer {
     ...
     */
    renderForwardLayer(camera: import('../camera.js').Camera, renderTarget: import('../../platform/graphics/render-target.js').RenderTarget, layer: import('../layer.js').Layer, transparent: boolean, shaderPass: number, viewBindGroups: import('../../platform/graphics/bind-group.js').BindGroup[], options?: {
        clearColor?: boolean;
        clearDepth?: boolean;
