...
class AxisArrow extends AxisShape {
	constructor(device, options = {}) {
		...
		this._tolerance = 0.1;
		this.meshTriDataList = [new MeshTriData(Mesh.fromGeometry(this.device, new ConeGeometry())), new MeshTriData(Mesh.fromGeometry(this.device, new CylinderGeometry()), 1)];
		this._createArrow();
	}
	set gap(value) {
...
class AxisBoxCenter extends AxisShape {
	constructor(device, options = {}) {
		...
		this.meshTriDataList = [new MeshTriData(Mesh.fromGeometry(this.device, new BoxGeometry()), 2)];
		this._createCenter();
	}
	_createCenter() {
...
class AxisBoxLine extends AxisShape {
	constructor(device, options = {}) {
		...
		this._boxSize = 0.12;
		this._tolerance = 0.1;
		this.meshTriDataList = [new MeshTriData(Mesh.fromGeometry(this.device, new BoxGeometry())), new MeshTriData(Mesh.fromGeometry(this.device, new CylinderGeometry()), 1)];
		this._createBoxLine();
	}
	set gap(value) {
		this._gap = value != null ? value : 0;
...
class AxisPlane extends AxisShape {
	constructor(device, options = {}) {
		...
		this._size = 0.2;
		this._gap = 0.1;
		this.meshTriDataList = [new MeshTriData(Mesh.fromGeometry(this.device, new PlaneGeometry()))];
		this._createPlane();
	}
	_getPosition() {
