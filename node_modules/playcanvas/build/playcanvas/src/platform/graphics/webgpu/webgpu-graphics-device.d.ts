export class WebgpuGraphicsDevice extends GraphicsDevice {
     ...
     */
    setBindGroup(index: number, bindGroup: import('../bind-group.js').BindGroup): void;
     ...
     * @ignore
     */
    clearStorageBuffer(storageBuffer: import('./webgpu-buffer.js').WebgpuBuffer, offset?: number, size?: number): void;
    /**
     ...
     * @ignore
     */
    readStorageBuffer(storageBuffer: import('./webgpu-buffer.js').WebgpuBuffer, offset?: number, size?: number, data?: ArrayBufferView, immediate?: boolean): Promise<ArrayBufferView>;
    /**
     ...
     */
    writeStorageBuffer(storageBuffer: import('./webgpu-buffer.js').WebgpuBuffer, bufferOffset: number, data: ArrayBufferView, dataOffset: number, size: number): void;
    /**
