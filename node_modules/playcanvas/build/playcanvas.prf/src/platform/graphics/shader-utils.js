...
class ShaderUtils {
	static createDefinition(device, options) {
		...
		const vertCode = ShaderUtils.versionCode(device) + getDefines(webgpuVS, gles3VS, '', true, options) + ShaderUtils.getDefinesCode(options.vertexDefines) + sharedFS + ShaderUtils.getShaderNameCode(name) + options.vertexCode;
